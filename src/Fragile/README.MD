...
- **Multiple Compression Algorithms**: Store, Deflate, LZMA, LZ4, ZStd, and BZip2
...
FragileArchivePartCollection parts = await FragileUtility.CreateArchiveDirectSplitAsync(
    "C:/Data/LargeFolder", 
